...
const Education = () => {
    return <Fragment>
        ...
        <Article country="Brazil" yearEnd={2018} title="Licentiate degree in Mathematics"
                 description="Universidade de Uberaba"/>
        <Article country="Brazil" yearEnd={2015} title="Aircraft Maintenance"
                 description="Escola de Aviação Civil Hélio Roberto do Amaral Ltda"/>
        <Article country="Brazil" yearEnd={2013} title="Industrial Mechanics and Maintenance Technology"
