...
const LeftColumn = () => {
    ...
    return <Fragment>
        <img className={styles.faceSquare} src={faceSquare} alt="Arthur Rochesso."/>
        ...
        <div className={styles.languagesContainer}>
            <img className={styles.languagesImg} src={brazilIcon} alt="Brazil - Portuguese"/>
            <img className={styles.languagesImg} src={ukIcon} alt="United Kingdom - English"/>
        </div>
